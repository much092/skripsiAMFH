...
const FotoTaskAdmin = ({navigation,route}) => {
...
const Item = ({ deskripsi,name,file }) => (
  ...
  <TouchableOpacity  style={{backgroundColor:'grey', }} onPress={()=>{setModalVisible(true),setImg(file)}}>
  <View 
  style={{
      flexDirection:'row' ,
      borderBottomWidth:0,
    ...
    return(
        ...
        <View style={{flex:1,marginHorizontal:0,marginVertical:10,backgroundColor:'white'}}>
            ...
            <Overlay isVisible={modalVisible} 
                ...
                <Image
                        source={{ uri: 'http://mppk-app.herokuapp.com/'+img }}
