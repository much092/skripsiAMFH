...
useEffect(()=>{
 ...
 const deleteData = async (props) =>{
  ...
  const fetchDataProject= async (props)=>{
    fetch("http://mppk-app.herokuapp.com/getDataProjectClient/"+idClient)
    .then(res=>res.json())
    .then(data=>{
        if(!data==[]){
            //console.log('nonull')
      ...
      <View style={{flex:1}}>
          ...
          <ScrollView>
              ...
              >
                ...
                <View style={{flexDirection:'row'}}>
                      ...
                      <View style={{flexDirection:'row'}}>
                        ...
                        <Text style={styles.titikdua}>:</Text>
                        <Text style={styles.subtext}>{perusahaan}</Text>
                      </View>
                </View>
              ...
              <View style={{
                    ...
                    <TouchableOpacity onPress={() => {navigation.navigate('EditClient',{id:idClient})}} style={styles.btnupdate}>
