 ...
 const renderContent = () => (
  ...
  >
    ...
    <View style={{flexDirection:'row',marginHorizontal:15}}>
        ...
        <TouchableOpacity onPress={()=>{navigation.navigate('Absensi',{id:idproject}),sheetRef.current.snapTo(1)}}
              style={{backgroundColor:'white',
                      width:70,
                      height:70,
                      borderRadius:50,
    ...
    >
      <View>
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <Text style={styles.subtext}>{namaproject}</Text>
        </View>
        <View style={{flexDirection:'row'}}>
        ...
        <View style={{flexDirection:'row'}}>
          ...
          <Text style={styles.titikdua}>:</Text>
          <Text style={styles.subtext}>{Math.round(listCountSelesai/listCountTotal*100)}%</Text>
        </View>
      </View>
