...
import {Splash,Login,Dashboard, Pegawai,AddPegawai, Client,AddClient,
    ...
    UploadFoto, FotoTaskAdmin, FotoTaskPM,DetailPegawai, AddAlat, AddMaterial, TeamAdmin, AbsensiPM, Absensi, ListAbsensi, EditClient, EditAlat, EditMaterial, EditPM, EditAdmin, EditP
    } from '../pages';
...
const AdminDrawerScreen = ({navigation})=>(
    <AdminDrawer.Navigator>
        ...
        <AdminDrawer.Screen name="Absensi" component={Absensi}
            options={{
                drawerIcon: config => <Icon
                size={23}
                name="clipboard"
